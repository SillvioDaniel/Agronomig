...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins">
  ...
  <body>
    ...
    <div class="mainmenu-area" style="background-color: #996633">
        <div class="container" >
            <div class="row">
                <div class="navbar-header" style="background-color: #996633">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                        <span style="background-color: #996633" class="sr-only">Alternar Navegação</span>
...
<!--TIRAR O SUBLINHADOOOOOOOOOOOOOOOOOOO-->
                <div class="navbar-collapse collapse" style="background-color: #996633">
                    <ul class="nav navbar-nav" style="background-color: #996633">
                        ...
                        if (empty($_SESSION['usuario']->conta)) {
                            ...
                            <li style='background-color: #996633'  class = 'active'><a href='conta.php'><i class='fa fa-user'></i> Conta</a></li>
...
<tbody>
    ...
    <!--Apresenta mensanges de sucesso-->
    <?php
...
<h2>Sua Conta</h2>
    <div class="form-group">
      ...
      <input type="text" value="<?php echo $_SESSION['usuario']->nome; ?>" class="form-control text-center" disabled="">
    </div>

    <div class="form-group">
        <label for="cpf">CPF:</label>
        <input type="text" value="<?php echo $_SESSION['usuario']->cpf; ?>" class="form-control text-center" disabled="">
    </div>
    ...
    if (empty($_SESSION['usuario']->conta)) {
        ...
        <input type='text' value='".$_SESSION['usuario']->pagamento."' class='form-control text-center' disabled=''></div>";
    }else{
        //Avaliacao
        echo "<div class='form-group'>
        <label for='avaliacao'>Média de Avaliações:</label><strong>
        <input type='text' value='".$_SESSION['usuario']->avaliacao." Estrelas' class='form-control text-center' disabled=''></strong></div>";
        //Banco
        echo "<div class='form-group'><label for='banco'>Banco:</label>
        <input type='text' value='".$_SESSION['usuario']->banco."' class='form-control text-center' disabled=''></div>";
        //Agencia
        echo "<div class='form-group'><label for='agencia'>Agencia:</label>
        <input type='text' value='".$_SESSION['usuario']->agencia."' class='form-control text-center' disabled=''></div>";
        //Conta
        echo "<div class='form-group'><label for='conta'>Conta:</label>
        <input type='text' value='".$_SESSION['usuario']->conta."' class='form-control text-center' disabled=''></div>";
    }?>
    </div>

    <div class="form-group">
      <label for="telefone">Telefone:</label>
      <input type="text" value="<?php echo $_SESSION['usuario']->telefone; ?>" class="form-control text-center" disabled="">
    </div>
          
    <div class="form-group">
      <label for="endereco">Endereço:</label>
      <input type="text" value="<?php echo $_SESSION['usuario']->endereco; ?>" class="form-control text-center" disabled="">
    </div>

    <div class="form-group">
      <label for="estado">Estado:</label>
      <input type="text" value="<?php echo $_SESSION['usuario']->estado; ?>" class="form-control text-center" disabled="">
    </div>

    <div class="form-group">
      <label for="email">E-mail:</label>
      <input type="text" value="<?php echo $_SESSION['usuario']->email; ?>" class="form-control text-center" disabled="">
    </div>

    <div class="form-group">
      <label for="usuario">Usuário:</label>
      <input type="text" value="<?php echo $_SESSION['usuario']->usuario; ?>" class="form-control text-center" disabled="">
    </div>

    <div class="form-group">
      <label for="senha">Senha:</label>
      <input type="text" value="<?php echo $_SESSION['usuario']->senha; ?>" class="form-control text-center" disabled="">
    </div><br>

<form action="editar.php" method="post">
    <button style="width: 60%;" onclick="document.getElementById('download').style.display='block'" class="btn btn-warning">Editar Dados</button>
</form>
    <center>
        <div class="col-md-12"> 
    <div class="checkbox">
