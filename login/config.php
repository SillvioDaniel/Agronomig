                ...
                <div class="col-md-4">
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li><a href="notificacao.php" class="w3-bar-item " title="Notificações"><i class="fa fa-bell"></i><span class=""><?php echo " ".$row_notificacoes['count(ativa)'];?></span> Notificações</a></li>                   
                            <li style="background-color:  #262626"><a href="config.php"><i class="fa fa-gear"></i> Configurações</a></li>
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        if (empty($_SESSION['usuario']->conta)) {
                            echo"<li><a href='login.php'><i class='fa fa-shopping-cart'></i> Loja</a></li>
...
<button style="width: 60%;" class="btn btn-info">Suporte</button><hr>
