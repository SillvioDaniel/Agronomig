...
$result_estoque = "SELECT * FROM estoque";
...
$result_estoques = "SELECT * FROM estoque limit $inicio, $quantidade_pg";
                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li class="dropdown dropdown-small">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="LOGIN.php">Português</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <?php echo "<li class = 'active'><a href=LOGIN.php?tx=".$login.">Loja</a></li>"?>
            ...
            <div class="col-md-12">
                        ...
                        <?php while ($rows_estoques = mysqli_fetch_assoc($resultado_estoques)){ ?>
                            ...
                            <div class="col-sm-4 col-md-2">
                                 ...
                                 <div class="thumbnail">
                                    <img src="<?php echo $rows_estoques['foto']; ?>" alt="..." style="width:200px; height: 200px">
                                    <div class="caption text-center">
                                        ...
                                        <p><a onclick="myFunction()" class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" <?php echo " href=carrinho.php?tx=".$login."&codigo_estoque=".$rows_estoques['codigo']."target=_self>"?><i class="fa fa-cart-plus"></i> Comprar Produto</a></p>
                        ...
                        <nav class="text-center" aria-label="Page navigation">
                            <ul class="pagination">
                                <li>
                                    ...
                                    <?php echo "<a href=LOGIN.php?tx=".$login."&pagina=".$pagina_anterior. "target=_self>"?>
                                ...
                                {?>
                                    <?php echo "<li><a href=LOGIN.php?tx=".$login."&pagina=".$i."target=_self>".$i."</a></li>"?>
                                    <?php } ?>
                                <li>
                                    <?php
                                    if($pagina_posterior <= $num_pagina){ ?>
                                        <?php echo "<a href=LOGIN.php?tx=".$login."&pagina=".$pagina_posterior."target=_self>"?>
