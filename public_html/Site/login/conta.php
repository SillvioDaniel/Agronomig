                    ...
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            ...
                            <li class="dropdown dropdown-small">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="conta.php">Português</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                       ...
                       <?php echo "<li class = 'active'><a href=conta.php?tx=".$login.">Conta</a></li>"?>
                    </ul>
                </div>  
            </div>
        </div>
...
<h2>Sua Conta</h2>
  <form action="LOGIN.php">
    ...
    <div class="form-group">
      ...
      <input type="text" value="<?php echo $cliente->nome; ?>" class="form-control" id="nome" disabled="">
    </div>
        <div class="form-group">
          <label for="cpf">CPF:</label>
          <input type="text" value="<?php echo $cliente->cpf; ?>" class="form-control" id="cpf" disabled="">
        </div>
        <div class="form-group">
      <label for="telefone">Telefone:</label>
      <input type="text" value="<?php echo $cliente->telefone; ?>" class="form-control" id="telefone" disabled="">
    </div>
          
    <div class="form-group">
      <label for="endereco">Endereço:</label>
      <input type="text" value="<?php echo $cliente->endereco; ?>" class="form-control" id="endereco" disabled="">
    </div>
       <div class="form-group">
      <label for="estado">Estado:</label>
      <input type="text" value="<?php echo $cliente->estado; ?>" class="form-control" id="estado" disabled="">
    </div>
    <div class="form-group">
      <label for="email">E-mail:</label>
      <input type="text" value="<?php echo $cliente->email; ?>" class="form-control" id="email" disabled="">
    </div>
