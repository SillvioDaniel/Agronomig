...
$result_visu_comentario = "SELECT * FROM comentarios";
$resultado_visu_comentario = mysqli_query($conn, $result_visu_comentario);
$total_visu_comentario = mysqli_num_rows ($resultado_visu_comentario);
?>
        ...
        <ul class="nav">
          ...
          <li class="active ">
            <a href="./comentarios.php">
              <i class="now-ui-icons design_bullet-list-67" style="color: black;"></i>
              <p style="color: black;">Lista de Comentários</p>
            </a>
          </li>
