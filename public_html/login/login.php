...
$result_estoque = "SELECT * FROM estoque_produto";
...
$result_estoques = "SELECT * FROM estoque_produto limit $inicio, $quantidade_pg";
                ...
                <div class="col-md-4">
                    <div class="header-right">
                        <ul class="list-unstyled list-inline">
                            <li><a href="notificacao.php" class="w3-bar-item w3-button w3-green w3-center w3-padding-large w3-hover-white" title="Notificações"><i class="fa fa-bell"></i><span  class=" w3-badge w3-right w3-green w3-center w3-green" ><?php echo " ".$row_notificacoes['count(ativa)'];?></span> Notificações</a>    </li>                   
                            <li><a href="config.php"><i class="fa fa-gear"></i> Configurações</a></li>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="login.php"><img src="img/logo.png"></a></h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li class = 'active'><a href="login.php"><i class='fa fa-shopping-cart'></i> Loja</a></li>
      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding"><center><br>
              <h2 class="w3-opacity">Procurar Produto</h2>
              <form>
<div class="container">
	<div class="row">
  <input type="text" name="procurar" style="text-align: center;" placeholder="Digite um produto.." text-align="center"><br>
</div>
</div>
</a>
</form><br>
              <button type="button" class="btn btn-primary"><i class="fa fa-search"></i>  Procurar</button> 
            </div>
          </div>
        </div>
      </div>
                            ...
                            <div class="col-sm-4 col-md-2">
                                 ...
                                 <div class="thumbnail">
                                    ...
                                    <div class="caption text-center">
                                        ...
                                        <p><a style="background-color:  #996633" onclick="myFunction()" class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" <?php echo " href=carrinho.php?codigo=".$rows_estoques['codigo_estoque'].">"?><i class="fa fa-cart-plus"></i> Comprar Produto</a></p>
